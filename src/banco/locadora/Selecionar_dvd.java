    ...
    private void selecionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_selecionarActionPerformed
        ...
        try{
            while(rs.next()){
                ...
                */
                Object[] dados_dvd = {rs.getInt("id_dvd"), rs.getString("titulo"), rs.getInt("class_etaria"), rs.getString("data_lancamento"), rs.getInt("qnt_locacao"), rs.getInt("qnt_total"), rs.getString("tipo")};
                model.addRow(dados_dvd);
            }
        }catch (Exception e){
            e.printStackTrace();
        }
